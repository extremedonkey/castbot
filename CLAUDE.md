...
- **🔐 ROLES & SECURITY** → [docs/03-features/RolesSecurity.md](docs/03-features/RolesSecurity.md) - `globalRoleAccess` whitelist: Settings UI + creation-time channel grants (Season Apps: View/Send/ReadHistory; Safari map locations/categories/map-storage: View/Send/ManageChannels). Helper: [utils/roleAccessUtils.js](utils/roleAccessUtils.js)
