...
export function parseTextEmoji(text, fallbackEmoji = '📦') {
    ...
    if (emojiMatch) {
        ...
        // Comprehensive emoji regex covering all Unicode emoji ranges (updated 2025)
        const regularEmojiMatch = text.match(/^([\u{1F300}-\u{1F9FF}]|[\u{1FA00}-\u{1FAFF}]|[\u{2600}-\u{26FF}]|[\u{2700}-\u{27BF}]|[\u{1F000}-\u{1F02F}]|[\u{1F0A0}-\u{1F0FF}]|[\u{1F100}-\u{1F64F}]|[\u{1F680}-\u{1F6FF}]|[\u{1F900}-\u{1F9FF}])/u);
