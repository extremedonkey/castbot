...
function normalize(data) {
  ...
  for (const [guildId, entry] of Object.entries(guilds)) {
    ...
    clean[guildId] = {
      ...
      // (No transfer cooldown field: moves are unlimited — Reece 2026-08-09.)
...
export async function revokeTier(guildId) {
  ...
  delete entry.transferLockedUntil; // legacy field (cooldown removed 2026-08-09) — scrub on revoke
