...
Are you sure you want to continue?`;
      ...
      return ButtonHandlerFactory.create({
        ...
        handler: async (context) => {
          try {
            ...
            console.log(`📦 START: map_item_drop_config - coord ${coord}, item ${itemId}`);
            ...
            if (!coordData || !item) {
              console.log(`❌ FAILED: map_item_drop_config - location or item not found`);
              return {
            ...
            console.log(`✅ SUCCESS: map_item_drop_config - showing config for ${itemId} at ${coord}`);
            ...
            console.error(`❌ ERROR: map_item_drop_config - ${error.message}`);
            return {
              content: '❌ Error configuring item drop. Please try again.',
              ephemeral: true
            };
          }
        }
      ...
      return ButtonHandlerFactory.create({
        ...
        handler: async (context) => {
          try {
            ...
            if (!itemId) {
              console.log(`❌ FAILED: map_item_drop_select - no item selected`);
              return {
                content: '❌ No item selected.',
                ephemeral: true
              };
            ...
            if (!coordData || !item) {
              console.log(`❌ FAILED: map_item_drop_select - location or item not found`);
              return {
                content: '❌ Location or item data not found.',
                ephemeral: true
              };
            ...
            console.log(`✅ SUCCESS: map_item_drop_select - showing config for ${itemId} at ${coord}`);
            ...
            console.error(`❌ ERROR: map_item_drop_select - ${error.message}`);
            return {
              content: '❌ Error configuring item drop. Please try again.',
              ephemeral: true
            };
      ...
      return ButtonHandlerFactory.create({
        ...
        handler: async (context) => {
          ...
          console.log(`💾 START: map_currency_drop_save - coord ${coord}, index ${dropIndex}`);
          ...
          console.log(`✅ SUCCESS: map_currency_drop_save - returning to drops management`);
      ...
      return ButtonHandlerFactory.create({
        ...
        handler: async (context) => {
          ...
          console.log(`🗑️ START: map_currency_drop_remove - coord ${coord}, index ${dropIndex}`);
          ...
          console.log(`✅ SUCCESS: map_currency_drop_remove - drop removed`);
    ...
    */
      ...
      try {
        ...
        if (entityType === 'map_cell') {
          try {
            const { safeUpdateAnchorMessage } = await import('./mapCellUpdater.js');
            console.log(`📍 Map cell ${entityId} checking for anchor message update...`);
