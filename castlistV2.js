...
function createPlayerCard(member, playerData, pronouns, timezone, formattedTime, showEmoji, displayMode = 'view', tribeData = null, guildId = null, allPlacements = {}, castlistId = 'default', navigationState = null) {
    ...
    if (displayMode === 'edit' && tribeData && guildId) {
        ...
        // 🔧 FIX: Use FULL castlistId including type suffix (castlist_{timestamp}_{type})
        // Entity IDs are: castlist_1760892362223_system, castlist_123_legacy, etc.
        // DO NOT strip the type suffix - it's part of the entity ID!
        // Button length calculation:
        //   edit_placement_ (15) + userId (18) + _ (1) + seasonContext (6-25) + _ (1) +
        //   castlistId (30-35) + _ (1) + tribeIdx (1) + _ (1) + tribePage (1) + _ (1) + mode (4)
        //   Total: ~80-105 chars (may exceed 100 with long season names)
