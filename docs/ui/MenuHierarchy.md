...
├─ #️⃣ Channels    season_channels_{configId}   open to all; guided Sections in season order (Subs→Conf→1on1s→Swap→Alliances), the four fabrication buttons 💎-lock for unentitled guilds; Msg Category is Premium-only
└─ ← Seasons · ✏️ Edit
