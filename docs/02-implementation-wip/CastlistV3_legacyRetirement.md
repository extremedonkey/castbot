...
- **Current State**: [docs/03-features/CastlistV3.md](../features/CastlistV3.md)
- **Architecture**: [docs/architecture/CastlistArchitecture.md](../architecture/CastlistArchitecture.md)
- **Feature Status**: [docs/03-features/CastlistV3-FeatureStatus.md](../features/CastlistV3-FeatureStatus.md)
- **Data Structures**: [docs/03-features/CastlistV3-DataStructures.md](../features/CastlistV3-DataStructures.md)
