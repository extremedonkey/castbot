...
#### **Documentation**
- `docs/03-features/StaminaItems.md`: Consumable stamina items
- `docs/03-features/Attributes.md`: Core points system architecture
- `docs/03-features/SafariMapSystem.md`: Movement and stamina usage
- `docs/03-features/SafariMapMovement.md`: Navigation mechanics
