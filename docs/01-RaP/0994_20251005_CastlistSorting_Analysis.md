...
- **[CastlistV3.md](../docs/03-features/CastlistV3.md)** - Overall architecture
- **[castlistSorter.js](../castlistSorter.js)** - Current sorting implementation
- **[CastlistV3-FeatureStatus.md](../docs/03-features/CastlistV3-FeatureStatus.md)** - Feature status matrix
- **[CastlistV3-AlumniPlacements.md](../docs/03-features/CastlistV3-AlumniPlacements.md)** - Placements system design
