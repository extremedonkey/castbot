...
- [SafariCustomActions.md](../docs/03-features/SafariCustomActions.md) - Modern action system
- [SafariMapDrops.md](../docs/03-features/SafariMapDrops.md) - Legacy drops documentation
