...
**Related Features**:
- [CastlistV3.md](../docs/03-features/CastlistV3.md) - Castlist system overview
- [CastlistNavigationParsing.md](../docs/03-features/CastlistNavigationParsing.md) - Navigation patterns
