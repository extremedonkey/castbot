...
- **[NewFeatureTipsGallery.md](../docs/02-implementation-wip/NewFeatureTipsGallery.md)** - Tips gallery architecture
- **[Placements.md](../docs/03-features/Placements.md)** - Modal submission pattern (UPDATE_MESSAGE fix)
