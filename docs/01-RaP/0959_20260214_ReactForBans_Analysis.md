...
**Related**: [ReactionRoleSystem.md](../docs/03-features/ReactionRoleSystem.md)
...
| File | Changes |
|------|---------|
| **docs/03-features/ReactionRoleSystem.md** | Fix all stale line references, add React for Bans section |
