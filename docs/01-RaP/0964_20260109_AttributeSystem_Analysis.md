...
- [Attributes.md](../docs/03-features/Attributes.md) - Current stamina documentation
- [EntityEditFramework.md](../docs/enablers/EntityEditFramework.md) - Framework for custom attributes UI
- [SafariCustomActions.md](../docs/03-features/SafariCustomActions.md) - Custom Actions integration
- [StaminaItems.md](../docs/03-features/StaminaItems.md) - Item stamina boost patterns
