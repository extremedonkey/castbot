...
- **Casting**: Safari completion affects application score
...
* Alignment to the existing CastBot UX patterns which is usage of a the Container component, with nested buttons, selects and other components V2 control. Please ensure you refer to docs/03-features/ComponentsV2.md for the Components V2 API reference.
