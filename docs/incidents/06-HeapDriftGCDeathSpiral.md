...
| # | Action | Type | Status |
|---|---|---|---|
| 1 | **Shorten 🌙 Auto-Restart interval 24h → 12h** (Data menu modal — no code, no deploy) | Config | ✅ Done 2026-07-26; superseded 2026-07-28 — reverted to 24h after the 2GB/1024MB-heap migration removed the need ([ProdBoxMigration.md](../03-features/ProdBoxMigration.md)) |
...
| 6 | **1GB+ Lightsail migration** — the box is now genuinely under-provisioned for the workload; verify static-IP reattach path (RaP 0896 §F) | Infra | ✅ Done 2026-07-28 as 2GB castbot-prod-2 ([ProdBoxMigration.md](../03-features/ProdBoxMigration.md)) |
