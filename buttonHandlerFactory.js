...
export const BUTTON_REGISTRY = {
  ...
  'casting_status_*': { label: 'Casting Status', description: 'Set draft casting status (Cast / Tentative / Don\'t Cast) via string select', emoji: '🎭', category: 'seasons' },
  'casting_messages_*': { label: 'Invitations', description: 'Customise & send cast/cut messages to applicants (coming soon)', emoji: '✒️', style: 'Secondary', category: 'seasons' },
