...
export const BUTTON_REGISTRY = {
  ...
  'casting_messages_*': { label: 'Bulk Invites', description: 'Open the Casting Invites modal (author + bulk-send outcome messages to applicants)', emoji: '✒️', style: 'Secondary', category: 'seasons' },
  'casting_send_*': { label: 'Send Invite', description: 'Open the single-applicant invite modal (Send Offer/Decline/Alternate, or Update Status Only)', emoji: '✒️', style: 'Primary', category: 'seasons', requiresModal: true },
